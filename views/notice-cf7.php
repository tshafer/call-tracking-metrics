<div id="top-cf7-notice" class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-900 p-4 rounded flex items-center justify-between gap-4 mb-2">
    ...
    <button type="button" onclick="dismissTopNotice('cf7')" class="text-yellow-700 hover:text-yellow-900 p-1 rounded hover:bg-yellow-200 transition" title="I don't use this plugin">
...
// Remove showNoticeMessage function and replace all calls with ctmShowToast
</script> 