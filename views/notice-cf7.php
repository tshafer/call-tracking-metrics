<div id="top-cf7-notice" class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-900 p-4 rounded flex items-center justify-between gap-4 mb-2">
    <div class="flex flex-col gap-2">
        <div class="flex items-center gap-4">
            <span class="font-semibold"><?php _e('Enable Contact Form 7 integration', 'call-tracking-metrics'); ?></span>
            <a href="<?= esc_url($cf7_url) ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded shadow transition"><?php _e('Install Contact Form 7', 'call-tracking-metrics'); ?></a>
        </div>
    ...
    <button type="button" onclick="dismissTopNotice('cf7')" class="text-yellow-700 hover:text-yellow-900 p-1 rounded hover:bg-yellow-200 transition" title="<?php _e('Dismiss this notice.', 'call-tracking-metrics'); ?>">
