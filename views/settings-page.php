        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="https://calltrackingmetrics.zendesk.com/hc/en-us/articles/360050247232-Getting-Started-with-CallTrackingMetrics" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 underline"><?php _e('Getting Started Guide', 'call-tracking-metrics'); ?></a></li>
                    <li><a href="https://calltrackingmetrics.zendesk.com/hc/en-us/categories/200216006-API-Developers" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 underline"><?php _e('API Documentation', 'call-tracking-metrics'); ?></a></li>
                    <li><a href="https://calltrackingmetrics.zendesk.com/hc/en-us/sections/200216016-Troubleshooting" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 underline"><?php _e('Troubleshooting Guide', 'call-tracking-metrics'); ?></a></li>
                </ul>
            </div>
