...
<div class="wrap max-w-full mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <?php if ($apiStatus === 'connected'): ?>
        ...
        <nav class="flex space-x-2">
            <a href="?page=call-tracking-metrics&tab=general" class="flex items-center px-4 py-2 rounded-t-lg font-medium transition-colors duration-200 <?= $active_tab === 'general' ? 'bg-[#02bdf6]' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
            ...
            <a href="?page=call-tracking-metrics&tab=logs" class="flex items-center px-4 py-2 rounded-t-lg font-medium transition-colors duration-200 <?= $active_tab === 'logs' ? 'bg-[#02bdf6] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="?page=call-tracking-metrics&tab=api" class="flex items-center px-4 py-2 rounded-t-lg font-medium transition-colors duration-200 <?= $active_tab === 'api' ? 'bg-[#02bdf6]' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0"></path>
                </svg>
                <span><?php _e('API Information', 'call-tracking-metrics'); ?></span>
            </a>
            <a href="?page=call-tracking-metrics&tab=import" class="flex items-center px-4 py-2 rounded-t-lg font-medium transition-colors duration-200 <?= $active_tab === 'import' ? 'bg-[#02bdf6]' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="?page=call-tracking-metrics&tab=debug" class="flex items-center px-4 py-2 rounded-t-lg font-medium transition-colors duration-200 <?= $active_tab === 'debug' ? 'bg-[#02bdf6]' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
