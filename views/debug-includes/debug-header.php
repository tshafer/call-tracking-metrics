...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 sm:p-6 p-4 mb-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
        ...
        <div class="flex items-center gap-1">
            ...
            <span class="text-gray-500 ml-1"><?php _e('Log Entries', 'call-tracking-metrics'); ?></span>
        </div>
        <div class="flex items-center gap-1">
            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span class="text-gray-500 ml-1"><?php _e('Days Logged', 'call-tracking-metrics'); ?></span>
        </div>
        <div class="flex items-center gap-1">
            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span class="text-gray-500 ml-1"><?php _e('Data', 'call-tracking-metrics'); ?></span>
        </div>
        <div class="flex items-center gap-1">
            ...
            <span class="text-gray-500 ml-1"><?php _e('Errors', 'call-tracking-metrics'); ?></span>
        </div>
        <div class="flex items-center gap-1">
            ...
            <span class="text-gray-500 ml-1"><?php _e('Warnings', 'call-tracking-metrics'); ?></span>
        </div>
        <div class="flex items-center gap-1">
            ...
            <span class="text-gray-500 ml-1"><?php _e('Info', 'call-tracking-metrics'); ?></span>
        </div>
        <div class="flex items-center gap-1">
            ...
            <span class="text-gray-500 ml-1"><?php _e('Debug', 'call-tracking-metrics'); ?></span>
        </div>
    </div>
    
    <?php if ($debugEnabled && !empty($log_stats['type_counts'])): ?>
        <div class="mt-6 border-t border-white/20">
            <h4 class="text-lg font-semibold mb-3"><?php _e('Log Type Distribution', 'call-tracking-metrics'); ?></h4>
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                ...
                ?>
                    <div class="text-center">
                        ...
                        <div class="text-xs text-blue-600 capitalize"><?php _e($type, 'call-tracking-metrics'); ?></div>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
